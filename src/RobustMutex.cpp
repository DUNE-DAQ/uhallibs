  ...
  , mSessionActive(false)
{
  ...
  if (s != 0) {
    ...
    log(lExc, "Error code ", uhal::Integer(s), " (", strerror(s), ") returned in mutex attr initialisation");
    throw lExc;
  }
  ...
  if (s != 0) {
    exception::MutexError lExc;
    log(lExc, "Error code ", uhal::Integer(s), " (", strerror(s), ") returned by pthread_mutexattr_setpshared");
    throw lExc;
  }
  ...
  if (s != 0) {
    exception::MutexError lExc;
    log(lExc, "Error code ", uhal::Integer(s), " (", strerror(s), ") returned by pthread_mutexattr_setrobust");
    throw lExc;
  }
  ...
  if (s != 0) {
    exception::MutexError lExc;
    log(lExc, "Error code ", uhal::Integer(s), " (", strerror(s), ") returned in mutex initialisation");
    throw lExc;
  }
}
...
RobustMutex::unlock()
{
  ...
  if (s != 0)
    log(uhal::Error(), "Error code ", uhal::Integer(s), " (", strerror(s), ") returned when unlocking mutex");
}

uint64_t
RobustMutex::getCounter() const
{
  return mCount;
}

bool
RobustMutex::isActive() const
{
