...
UHAL_DEFINE_DERIVED_EXCEPTION_CLASS(FlxCommunicationError,
                                    uhal::exception::TransportLayerError,
                                    "Exception class to handle a low-level seek/read/write error after initialisation.")
}
