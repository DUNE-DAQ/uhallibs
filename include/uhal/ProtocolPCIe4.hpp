...
#ifndef _uhal_ProtocolPCIe4_hpp_
#define _uhal_ProtocolPCIe4_hpp_
...
namespace uhal
{
  ...
  namespace exception
  {
    //! Exception class to handle the case in which the PCIe4 connection timed out.
    UHAL_DEFINE_DERIVED_EXCEPTION_CLASS ( PCIe4Timeout , ClientTimeout , "Exception class to handle the case in which the PCIe4 connection timed out." )
    //! Exception class to handle a failure to read from the specified device files during initialisation
    UHAL_DEFINE_DERIVED_EXCEPTION_CLASS ( PCIe4InitialisationError , TransportLayerError , "Exception class to handle a failure to read from the specified device files during initialisation." )
    //! Exception class to handle a low-level seek/read/write error after initialisation
    UHAL_DEFINE_DERIVED_EXCEPTION_CLASS ( PCIe4CommunicationError , TransportLayerError , "Exception class to handle a low-level seek/read/write error after initialisation." )
  ...
  //! Transport protocol to transfer an IPbus buffer via PCIe4
  class PCIe4 : public IPbus< 2 , 0 >
  {
    public:
      class PacketFmt {
      public:
    ...
    public:
      ...
      */
      PCIe4 ( const std::string& aId, const URI& aUri );
    ...
    private:
      ...
      PCIe4 ( const PCIe4& aPCIe );

      PCIe4& operator= ( const PCIe4& aPCIe );
